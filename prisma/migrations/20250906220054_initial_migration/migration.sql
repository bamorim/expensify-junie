...
-- CreateEnum
CREATE TYPE "public"."InvitationStatus" AS ENUM ('PENDING', 'ACCEPTED', 'EXPIRED', 'CANCELED');
...
-- CreateIndex
CREATE UNIQUE INDEX "Invitation_orgId_email_status_key" ON "public"."Invitation"("orgId", "email", "status");
...
-- AddForeignKey
ALTER TABLE "public"."Invitation" ADD CONSTRAINT "Invitation_recipientId_fkey" FOREIGN KEY ("recipientId") REFERENCES "public"."User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
